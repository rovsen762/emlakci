    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_area', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Property Area')),
                ...
                ('location_area', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Property Area')),
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='properties.propertysource')),
            ],
            options={
